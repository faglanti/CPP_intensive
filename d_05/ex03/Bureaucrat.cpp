...
/*   Updated: 2022/11/02 11:02:16 by faglanti         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void Bureaucrat::executeForm(Form const& form){
	if (form.getIndicator() == false)
		std::cout << form.getNameF() << " can't be executed because it's unsigned" << std::endl;
	else if (form.getGradeExecute() < this->_grade)
		std::cout << form.getNameF() << " can't be executed because bureaucrat grade is low" << std::endl;
	else{
		form.execute(*this);
		std::cout << this->getName() << " executed " << form.getNameF() << std::endl;
	}
}
